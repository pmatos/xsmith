...
(add-prop non-generating
          ...
          [Expression #t]
          [BinaryExpression #t]
          [IntOnlyBinaryExpression #t]
          [ComparisonExpressionExpression #t]

          ;; Unsafe nodes should be generated by analysis transformations,
          ;; not random choice.
          [UnsafeAdditionExpression #t]
          [UnsafeSubtractionExpression #t]
          [UnsafeMultiplicationExpression #t]
          [UnsafeDivisionExpression #t]
          [UnsafeModulusExpression #t]
          )
