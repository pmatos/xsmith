...
@itemlist[
@item{@racket['scope-graph-binding] -- not yet generated by a property, needed by the other scope graph stuff}
]
...
When the attributes @racket['resolve-reference-name] and @racket['visible-bindings] are used, this regexp determines valid scope-graph resolution paths.
...
@item{visible-bindings -- used by the visible-bindings attribute}
